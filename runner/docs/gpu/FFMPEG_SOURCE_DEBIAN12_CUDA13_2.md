# FFmpeg GPU source build on Debian 12 with CUDA 13.2

## Scope

Build and install the FFmpeg GPU binary historically used with Debian 12 and CUDA 13.2.
...
- Complete [DEBIAN12_CUDA13_2.md](DEBIAN12_CUDA13_2.md).
- Confirm that `nvidia-smi` and `/usr/local/cuda-13.2/bin/nvcc` work.
...
This step preserves the procedure that was historically validated on Debian 12:
