...
def set_version(new_version: str) -> None:
    ...
    print(
        f"  3. Create a git tag: git tag -a esup-runner-manager-v{new_version} -m 'Esup-Runner Manager release {new_version}'"
    )
    print(
        f"  4. Push changes and tag: git push origin main && git push origin esup-runner-manager-v{new_version}"
    )
